 ...
 * It is filled with methods that access and store or extract values from the DB\n
 * To acces the DB we use Jenkins\n
 * The es.deusto.client.ExampleClient methods are usually connected to the ones in this class
 * 
 */
